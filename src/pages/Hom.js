...
const Home = () => {
  ...
  return (
    <Container sx={{ mt: 5 }}>
      <Typography variant="h4" component="h1" gutterBottom sx={{ textAlign: 'center', fontSize:'38px', color: '#e4003a' }}>
      ...
      <Box sx={{ mt: 4, textAlign: 'center' }}>
        <Button variant="contained" size="large" onClick={handleStartStudy} endIcon={<NavigateNextIcon />}>
          Commencer l'étude
        </Button>
      </Box>
    </Container>
