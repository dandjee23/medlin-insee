  ...
  return (
    <Container>
      ...
      <Alert severity="info" variant="outlined" style={{ marginBottom: '20px' }}>
        Veuillez choisir votre zone d'implantation en sélectionnant dans la liste de département.
      </Alert>
      <Box display="flex">
        <MapContainer 
        ...
        <Paper elevation={3} style={{ width: '300px', padding: '10px' }}>
          <Typography gutterBottom style={{ color: '#286AC7' }}>Départements:</Typography>
          <Select
            id="departments"
