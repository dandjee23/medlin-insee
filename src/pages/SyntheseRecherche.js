        ...
        <Box padding={2} border={1} borderColor="divider" borderRadius={2} marginTop={1} backgroundColor="white" height={600}>
          ...
          {tabIndex === 1 && (
            <Box height="100%">
              ...
              <MapContainer center={[46.7111, 1.7191]} zoom={6} style={{ height: '100%', width: '100%' }}>
                <TileLayer
                    ...
                    return (
                      <Marker key={index} position={coords}>
                        <Popup>
                          ...
                          {adresseEtablissement.numeroVoieEtablissement} {adresseEtablissement.typeVoieEtablissement} {adresseEtablissement.libelleVoieEtablissement}<br />
